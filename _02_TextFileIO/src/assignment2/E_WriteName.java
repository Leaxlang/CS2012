...
public class E_WriteName{
	public static void main(String[] args) {
		...
		try {
			File firstNames = new File("src/assignment2/firstNames.txt");
		...
		try {
			File lastNames = new File("src/assignment2/lastNames.txt");
		...
		//making the new file
		try {
			File randomPeople = new File("src/assignment2/randomPeople.txt");
